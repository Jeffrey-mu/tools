...
<template>
  <div class="h-[calc(100vh-8rem)] flex flex-col gap-4 w-full min-w-0">
    ...
    <div class="flex-1 flex flex-col lg:flex-row gap-4 min-h-0">
      <!-- Input Area -->
      <div class="flex-1 min-h-0 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col">
        <textarea
          v-model="text"
      ...
      <!-- Stats Panel -->
      <div class="w-full lg:w-72 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 h-fit space-y-4">
        <h3 class="font-bold text-gray-800 dark:text-gray-100">统计结果</h3>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-1 gap-3">
          ...
          <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
            ...
            <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats.zh }}</div>
          </div>
          
          <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">英文单词</div>
            <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats.en }}</div>
          </div>

          <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">不含空格</div>
            <div class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ stats.noSpace }}</div>
          </div>
          
          <div class="flex gap-3 col-span-2 lg:col-span-1">
            <div class="flex-1 bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
              <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">行数</div>
              <div class="text-xl font-bold text-gray-900 dark:text-gray-100">{{ stats.lines }}</div>
            </div>
            <div class="flex-1 bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-100 dark:border-gray-700">
              <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">段落</div>
